...
// inc_ref needed for each constructed object
// see AstImpl in high-level.js
...
console.log("Expression: ", Z3.ast_to_string(ctx,z_plus_xy));
...
console.log("Expression inlined: ", Z3.ast_to_string(ctx,
    Z3.mk_add(ctx,[
        Z3.mk_const(ctx,Z3.mk_string_symbol(ctx,"z"),Z3.mk_int_sort(ctx)),
        Z3.mk_const(ctx,Z3.mk_string_symbol(ctx,"x"),Z3.mk_int_sort(ctx)),
        Z3.mk_numeral(ctx,"5",Z3.mk_int_sort(ctx))
    ])
));
